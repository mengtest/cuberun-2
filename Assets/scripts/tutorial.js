...
function Start () {
	...
	dialogo[2] = "El juego consiste de aguantar el mayor tiempo posible sin colisionar con ningun obstaculo.";
	dialogo[3] = "El personaje es un cubo.";
	dialogo[4] = "Puedes controlar al cubo tocando la mitad derecha e izquierda de la pantalla para que se mueva en esas direcciones.";
	dialogo[5] = "El personaje avanza automaticamente hacia delante cada vez mas rapido";
